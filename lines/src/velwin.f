...
C     try to get window to expand instead of only to shrink 2011-05-18
c      N1 = MAX (1, N1)
      IF (N1 .LT. 1) N1 = 1
      IF (N1 .GT. NAXIS1(MEM)) N1 = NAXIS1(MEM)
C      N1 = MIN (N1, NAXIS1(MEM))
      CALL AITOV (MEM, N1, V1)
      IF (DB) PRINT *,'in VELWIN wanted N1=',N1,' V1=',V1
*
      CALL XTOAI (MEM, V2, N2)
c      N2 = N2 + 1
c      N2 = MIN (N2, NAXIS1(MEM))
      IF (N2 .LT. 1) N2 = 1
      IF (N2 .GT. NAXIS1(MEM)) N2 = NAXIS1(MEM)
c      N2 = MAX (N1, N2)
      CALL AITOV (MEM, N2, V2) 
      IF (DB) PRINT *,'in VELWIN wanted N2=',N2,' V2=',V2
